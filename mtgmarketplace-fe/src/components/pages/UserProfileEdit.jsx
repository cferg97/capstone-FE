...
const UserProfileEdit = () => {
  ...
  if (currentUser) {
    return (
      ...
      >
        <Tab.Container defaultActiveKey="basic-profile">
          <Col sm={3} className="text-center">
            ...
            >
              <Nav.Item>
                <Nav.Link eventKey="basic-profile">Basic Information</Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link eventKey="address">Address Information</Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link eventKey="listings">Selling Information</Nav.Link>
              </Nav.Item>
            </Nav>
          </Col>
          <Col sm={{ span: 8, offset: 1 }}>
            ...
            >
              <Tab.Pane eventKey="basic-profile">
                <Container>
                  ...
                  <Container>
                    <Form>
                      ...
                      <Form.Group className="mb-3">
                        ...
                        />
                        <Form.Text>
                          Your registered last name is: {currentUser?.lastName}
                        </Form.Text>
                      </Form.Group>
              ...
              <Tab.Pane eventKey="address">
                <Container>
                  <h3 className="my-2">Address Information</h3>
                  <p>Your current registered address is:</p>
